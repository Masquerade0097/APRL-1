...
--
-- Host: localhost
-- Generation Time: Aug 11, 2018 at 03:07 PM
...
(1, '2', 'This will call the normal command found in our path, without using the aliased version.\r\n\r\nAssuming you did not unset it, the ll alias will be available throughout the current shell session, but when you open a new terminal window, this will not be available.\r\n\r\nTo make this persistent, we need to add this into one of the various files that is read when a shell session begins. Popular choices are ~/.bashrc and ~/.bash_profile. We just need to open the file and add the alias there:', '2018-05-29 12:00:39', 'no url', 3, 1946, 7166, 'Journey To End Of Earth', '', ''),
...
(53, '2', '<p>Game of thrones ia na epic love story between a beautiful princess and an average lokking man.</p>', '2018-05-29 11:07:18', NULL, 0, 0, 2, 'Game of thrones', 'story love thrones na ia epic ', NULL),
(54, '2', '<p>We are all victims, Answlmo. Our destinies are decided by a cosmic roll of the dice, the winds of the stars, the vagrant breezes of fortune that blow from the windmills of the gods.</p>', '2018-05-29 11:14:48', '', 0, 0, 12, 'Hell to the world.', 'windmills vagrant breezes cosmic winds roll ', ''),
(55, '2', '<p>This is a simple testing blog for the project. It is an interacting platform for researchers and learners.</p>', '2018-05-29 11:13:02', '', 0, 0, 5, 'Blog number 1', 'simple blog testing ', ''),
(56, '2', '<p><span class="st"><em>Redmine</em> is a free and open source, web-based project management and issue tracking tool. It allows users to manage multiple projects and associated&nbsp;...</span></p>', '2018-05-29 12:02:37', '', 0, 0, 1, 'pool', 'tracking multiple tool manage project management based issue projects ', '');
...
('2', 'Aditya', 'Nigam', 'aditya@iitmandi.ac.in', '2.jpg', 'Web-Developer', 'I am interested in ML.', 2147483647),
...
INSERT INTO `project` (`project_id`, `offeredby`, `title`, `description`, `addedon`, `incentive`, `lastdate`, `status`, `fame_fund`) VALUES
(1, 'Narendra Karmarkar', 'Linear Programming', 'Linear programming plays a very important role in optimization models. We can use our resources fully if we can optimize its use and this model can be formed with linear programming.', '2017-11-03', '0', '2018-05-31', 'current', 100),
(2, '2', 'Machine Learning', 'Hello', '2017-11-03', 'Rs.1500 per week.', '2018-05-31', 'available', 2),
(3, 'Aditya Nigam', 'Deep Learning', 'This project is intended to introduce you to basic deep learning reinforcement techniques.', '2017-11-02', '0', '2018-05-31', 'finished', 0),
(4, '2', 'Thunderbird mail service', 'This project aim to introduce to open source contribution.We will create a plugin for open source thunderbird mail client.', '2017-11-01', 'Rs.2000-/', '2018-05-31', 'available', 0),
(6, 'Arti Kashyap', 'Mysql Basics', 'MySQL (officially pronounced as "My S-Q-L",[6]) is an open-source relational database management system (RDBMS).[7] Its name is a combination of "My", the name of co-founder Michael Widenius\'s daughter,[8] and "SQL", the abbreviation for Structured Query Language. The MySQL development project has made its source code available under the terms of the GNU General Public License, as well as under a variety of proprietary agreements. MySQL was owned and sponsored by a single for-profit firm, the Swedish company MySQL AB, now owned by Oracle Corporation.[9] For proprietary use, several paid editions are available, and offer additional functionality.\r\nMySQL is a central component of the LAMP open-source web application software stack (and other "AMP" stacks). LAMP is an acronym for "Linux, Apache, MySQL, Perl/PHP/Python". Applications that use the MySQL database include: TYPO3, MODx, Joomla, WordPress, phpBB, MyBB, and Drupal. MySQL is also used in many high-profile, large-scale websites, including Google[10][11] (though not for searches), Facebook,[12][13][14] Twitter,[15] Flickr,[16] and YouTube.[17]', '2017-11-06', '0', '2018-05-31', 'available', 0),
(8, '2', 'New Projet', '', '2018-05-29', '5656', '2017-04-28', 'available', 0);
...
INSERT INTO `projectimage` (`id`, `project_id`, `imageurl`) VALUES
(1, 4, '2.jpg');
...
('pd', 'Prabhakar', 'Prasad', 'prabhakarpd7284@gmail.com', 'pd.jpg', '', '', '', '0');
...
INSERT INTO `userlogin` (`username`, `password`, `profession`, `fame`) VALUES
('2', 'da4b9237bacccdf19c0760cab7aec4a8359010b0', 'faculty', 98),
('Arti Kashyap', 'arti', 'faculty', 100),
('hello', 'aaf4c61ddcc5e8a2dabede0f3b482cd9aea9434d', 'student', 100),
('mohan', 'abee2cb38f12d53e4682bab140e8f4b568816eee', 'student', 100),
('pd', 'e9efe2aea5ad46614d39e809e89207fa6f915ffe', 'student', 100),
('prabhakarpd7284', 'prabhakarpd7284', 'student', 100);
...
--
ALTER TABLE `blog`
  MODIFY `blog_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=57;
--
