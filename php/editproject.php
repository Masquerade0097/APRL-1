...
if($id!=-1){
  if(isset($_POST['submit'])){
     ...
     // $status = $_POST['status'];
      ...
      or die('Lock queryl1 WRITE');

    //   if(!is_dir(APRL_UPLOADPATH."project/")) {
    //       mkdir(APRL_UPLOADPATH.'project'); 
    //   }
      if(!file_exists(APRL_UPLOADPATH."project/".$id.'/')) {
          mkdir(APRL_UPLOADPATH.'project/'.$id,0777,true); 
      }
    $image1 = $username.'.jpg';      
                ...
                <form enctype="multipart/form-data" method="post" action= "editproject.php/?id='.$id.'" >
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <textarea type="text" class="form-control" placeholder="Description" name="description" >'.$olddescription.'</textarea>
                            </div>
                            <div id="textareaTags">
